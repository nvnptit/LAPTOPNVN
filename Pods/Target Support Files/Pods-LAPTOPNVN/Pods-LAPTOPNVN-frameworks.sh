...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/JXReviewController/JXReviewController.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/UIButtonSetBackgroundColorForState/UIButtonSetBackgroundColorForState.framework"
fi
